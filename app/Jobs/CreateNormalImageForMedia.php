...
class CreateNormalImageForMedia implements ShouldQueue
{
    ...
    public function handle(MediaRepository $mediaRepository)
    {
        ...
        Image::load($path)->optimize()->makeNormalImage();

        $mediaRepository->storeImage($this->mediaId, $path, \App\Models\Media::NORMALIMAGE);
    }
